object Form_processing: TForm_processing
  ...
  object TextProg: TLabel
    ...
    Width = 296
    Height = 13
    Caption = 'Find amount and index of first negative element in selected row'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object CSelectedRowEdit: TSpinEdit
    Left = 180
    Top = 75
    Width = 80
    Height = 22
